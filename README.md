...
- [**kNN Continent Classifier**](https://github.com/robertfmath/kNN-Continent-Classifier): predicting the continent of a given set of coordinates, based on data that maps the coordinates of cities around the world to the continent those cities' countries reside in
